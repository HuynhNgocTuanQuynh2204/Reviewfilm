...
<h3 style="text-align: center; text-transform: uppercase; font-weight: bold;">Bài review mới nhất</h3>
<?php
...
?>
    <a href="danhmucreview.php?iddanhmuc=<?php echo $row_dm['id_danhmuc'] ?>" class="btn btn-primary"><?php echo $row_dm['tendanhmuc'] ?></a>
    <?php
    }
    ?>
</p>
...
<div class="row"> <!-- Di chuyển row ra ngoài vòng lặp -->
    ...
    <div class="col-md-3 col-sm-6 mb-4"> <!-- Đặt cột trong vòng lặp -->
        <div class="post-item text-center p-2" style="border: 1px solid #ddd; border-radius: 8px;">
            <a href="chitietbaiviet.php?idbaiviet=<?php echo $row['id_baiviet'] ?>" style="text-decoration: none;">
